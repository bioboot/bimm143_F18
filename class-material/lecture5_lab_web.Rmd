...
plot(genes$Condition1, genes$Condition2, col=genes$State, xlab="Expression condition 1", ylab="Expresion condition 2")
```
...
plot(meth$promoter.meth, meth$gene.meth, ylab="Gene Methylation", xlab="Promotor Methylation")
```
